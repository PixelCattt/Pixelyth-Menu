/*
** Pixelyth-Menu - Managers/SoundManager.cs
    ...
    public class SoundManager
    {
        public static readonly Dictionary<string, Dictionary<string, object>> Sounds = new Dictionary<string, Dictionary<string, object>>
        {
            ["Buttons"] = new Dictionary<string, object>
            {
                ...
                { "Lever", "Audio/Menu/Buttons/lever$1.ogg" },
                { "Minecraft", "Audio/Menu/Buttons/click.ogg" },
                { "Rec Room", "Audio/Menu/Buttons/rr.ogg" },
                ...
                { "Clicker", "Audio/Menu/Buttons/dog.ogg" },
                ...
                { "Portal 2", "Audio/Menu/Buttons/portal2.ogg" },
